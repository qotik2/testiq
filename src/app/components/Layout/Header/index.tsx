        ...
        <div
          ...
          <nav className='flex flex-col items-start p-4'>
            ...
            <div className='mt-4 flex flex-col space-y-4 w-full'>
              ...
              <button
                className='bg-lightblue text-primary px-4 py-2 rounded-lg border border-primary hover:text-white hover:bg-primary hover:cursor-pointer transition duration-300 ease-in-out'
                onClick={() => {
                  setIsSignUpOpen(true)
                  setNavbarOpen(false)
                }}>
